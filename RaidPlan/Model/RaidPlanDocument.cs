...
public sealed class RaidPlanDocument
{
    ...
    public static RaidPlanDocument CreateDefault(string name = "New plan", int seats = 8)
    {
        var doc = new RaidPlanDocument { Name = name };

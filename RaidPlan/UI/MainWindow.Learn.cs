...
public sealed partial class MainWindow
{
    ...
    private void DrawLearnedTab(RaidPlanDocument plan)
    {
        var learner = Plugin.Learner;
        var memory = learner.Current;

        ImGui.TextWrapped(
            "RaidPlan watches your pulls and remembers when each cast happens. Once it has seen a " +
    ...
    private void DrawGenerator(RaidPlanDocument plan, FightMemory memory)
    {
    ...
    private void GenerateSteps(RaidPlanDocument plan, List<LearnedCast> candidates, bool withSlides = false)
    {
        var added = 0;
        var skipped = 0;
    ...
    private void DrawLearnedTable(RaidPlanDocument plan, FightMemory memory, EncounterLearner learner)
    {

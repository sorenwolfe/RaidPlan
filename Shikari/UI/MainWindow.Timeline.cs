...
public sealed partial class MainWindow
{
    ...
    private void DrawTimelineTab(PlanDocument plan)
    {
    ...
    private void DrawTimelineList(PlanDocument plan)
    {
    ...
    private void DrawEntryEditor(PlanDocument plan, TimelineEntry entry)
    {
        ...
        UiHelpers.HelpMarker(
            ...
            "Learned timing — fires when Shikari expects the cast, based on your previous pulls, " +
    ...
    private void DrawPredictionStatus(TimelineEntry entry)
    {
        ...
        if (learned == null || learned.Samples.Count == 0)
        {
            ImGui.TextDisabled(
                ...
                "until Shikari has watched a few pulls.");
            return;
        }
    ...
    private void DrawAssignmentTable(PlanDocument plan, TimelineEntry entry)
    {
    ...
    private void DrawPersonalCalls(PlanDocument plan, TimelineEntry entry)
    {
